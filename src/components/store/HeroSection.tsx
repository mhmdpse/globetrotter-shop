  ...
  const heroSlides = [
    {
      ...
      title: "Discover Premium Style",
      description: "Explore our curated collection of premium fashion, electronics, and lifestyle products. Quality meets innovation in every piece.",
    ...
    },
    {
      ...
      badge: "New Arrivals",
      title: "Latest Trends",
      description: "Stay ahead with our newest arrivals featuring cutting-edge design and unmatched quality. Innovation meets style.",
      cta1: "Explore New",
      cta2: "View Catalog"
    }
  ];
      ...
      <Carousel className="w-full h-full">
        <CarouselContent>
          {heroSlides.map((slide, index) => (
            <CarouselItem key={index} className="relative min-h-[70vh] flex items-center">
              {/* Background Image */}
